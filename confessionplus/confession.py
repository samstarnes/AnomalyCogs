...
class Confession(BaseCog):
    ...
    async def send_confession(self, ctx, confession_guild, confession):
        ...
        try:
            ...
            await ctx.bot.send_filtered(destination=confession_room, filter_mass_mentions=False, filter_invite_links=False, filter_all_links=False, content=cauth confession)
